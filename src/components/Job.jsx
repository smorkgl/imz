        ...
        <div>
            <div className="job-container mt-10 bg-[url('/src/img/job.png')] bg-cover bg-no-repeat bg-center flex place-items-center select-none cursor-default ">
                <div className="job-container__inside text-white ml-60 box-shadow rounded-3xl">
                    ...
                    <Link to={`/imz/job`}><a href="#" class="inline-flex items-center p-3 m-3 text-lg font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 mt-8">
            Узнать о вакансиях
