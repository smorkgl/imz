...
<button type="button" class="inline-flex items-center font-medium justify-center p-0 text-sm text-gray-900 dark:text-white rounded-lg cursor-pointer">
      ...
      {isDropdownVisibleLang && <div class="language-open absolute z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 transition animate-fade animate-duration-[200ms] cursor-pointer hover:bg-blue-800 hover:text-white" id="language-dropdown-menu">
