          ...
          >
            ...
            <Slider className="h-60">
              ...
              <Slide index={2}>
                <p className="slide-text__mobile">
                  {" "}
                  На базе ООО "Исаевский машиностроительный завод" в 2022 году
                  был открыт первый исправительный центр ИК-1. В настоящее время
                  было построено 2 модульных здания на территории завода и
                  введены в эксплуатацию. Планируется постройка 3 модульного
                  здания. В данный момент на завод трудоустроены больше 150
                  заключенных.
                </p>
