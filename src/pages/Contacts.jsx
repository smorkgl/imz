          ...
          <div className="xl:px-2 md:w-full   z-10 h-full h bg-white text-black w-2/4 grid place-items-center pb-5">
            <div className="">
              <p>
                ...
                <br />
                <b>Наш адрес:</b> Ростовская Область, м.р-н Красносулинский,
                с.п. Михайловское, п Молодежный, ул. Степная, зд. 3
              ...
              <p className="pt-5">
                ...
                <br /> <b>Отдел снабжения: </b>+7 (863) 333-31-34 доб. 161
                <br />
                <b>Директор по кадрам:</b>+7 (863) 333-31-34 доб. 128 <br />{" "}
                <b>Главный механик: </b>+7 (863) 333-31-34 доб. 115
                <br />
                <b>Главный энергетик: </b>+7 (863) 333-31-34 доб. 230
                <br />
                <b>Коммерческий отдел: </b>+7 (863) 333-31-34 доб. 125, 140, 191
                <br />
                <b>Юридический отдел: </b>+7 (863) 333-31-34 доб. 129
              </p>
              <p className="pt-5">
            ...
            <div className="xl:pl-5 absolute z-10 h-full h bg-white text-black w-2/4 grid place-items-center pr-10">
              <div className="">
                ...
                <p className="pt-5">
                  ...
                  <b>Главный энергетик: </b>+7 (863) 333-31-34 доб. 230
                  <br />
                  <b>Коммерческий отдел: </b>+7 (863) 333-31-34 доб. 125, 140,
                  191
                  <br />
                  <b>Юридический отдел: </b>+7 (863) 333-31-34 доб. 129
                </p>
